...
public final class LgoAdapters {
  ...
  public static FundingRecord adaptOperation(LgoOperation lgoOperation) {
    return new FundingRecord.Builder()
        .setAddress(lgoOperation.getCounterParty())
        .setAmount(new BigDecimal(lgoOperation.getQuantity()))
        .setCurrency(Currency.getInstance(lgoOperation.getCurrency()))
        .build();
  }
}
